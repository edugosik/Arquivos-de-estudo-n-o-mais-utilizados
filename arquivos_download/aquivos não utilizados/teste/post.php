...
<body>
<div id="all">
    <form action="fazendo_o_post.php" method="post">
    <h2>Post</h2>
        ...
        <div class="form-group">
            <label for="exampleInputEmail1" >Texto:</label><br/>
            <textarea type="text" class="form-control" name="texto" class="texto001" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Escreva o seu texto" padding: 150px 300px;></textarea>
        </div>
        ...
        <button type="submit" class="btn btn-primary" >
            <a href="index.php" class="linkLC">login</a>
        </button>
